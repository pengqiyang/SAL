...
def argument_parser():
    ...
    ##some src file
    parser.add_argument('--adj-file', type=str, default='',
                        help="sampler for trainloader")

    parser.add_argument('--t', default=0.9, type=float,
                        help="the epoch to start adding consistent loss")
    parser.add_argument('--extra-adj', default=0.0001, type=float,
                        help="the epoch to start adding consistent loss")
    parser.add_argument('--adj-init', default=0.01, type=float,
                        help="the epoch to start adding consistent loss")
    parser.add_argument('--extra-num', default=0, type=int,
                        help="the epoch to start adding consistent loss")                     
    parser.add_argument('--sc-alone-lr', default=0.9, type=float,
                        help="the epoch to start adding consistent loss")
    parser.add_argument('--al-alone-lr', default=0.9, type=float,
                        help="the epoch to start adding consistent loss")                        
    parser.add_argument('--sc-alone-gamma', default=0.9, type=float,
                        help="the epoch to start adding consistent loss")
    parser.add_argument('--al-alone-gamma', default=0.9, type=float,
                        help="the epoch to start adding consistent loss") 
    return parser
...
def optimizer_kwargs_sc_alone(parsed_args):
    """
    Build kwargs for optimizer in optimizer.py from
    the parsed command-line arguments.
    """
    return {
        'optim': parsed_args.optim,
        'lr': parsed_args.sc_alone_lr,#0.0001,
        'weight_decay': parsed_args.weight_decay,
        'momentum': parsed_args.momentum,
        'sgd_dampening': parsed_args.sgd_dampening,
        'sgd_nesterov': parsed_args.sgd_nesterov,
...
def optimizer_kwargs_al_alone(parsed_args):
    """
    Build kwargs for optimizer in optimizer.py from
    the parsed command-line arguments.
    """
    return {
        'optim': parsed_args.optim,
        'lr': parsed_args.al_alone_lr,#0.000001,
        'weight_decay': parsed_args.weight_decay,
        'momentum': parsed_args.momentum,
        'sgd_dampening': parsed_args.sgd_dampening,
        'sgd_nesterov': parsed_args.sgd_nesterov,
