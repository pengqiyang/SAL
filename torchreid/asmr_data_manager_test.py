...
from .asmr_folder_test import Train_Dataset, Test_Dataset, Base_Dataset
...
class ImageDataManager(BaseDataManager):
    ...
    def __init__(self,
        ...
        train_dataset = Train_Dataset(base_dataset, train_val='train', glove_start = True)
        ...
        self.trainloader = DataLoader(
                train_dataset,
                #sampler=RandomIdentitySampler(train_dataset,self.train_batch_size,1),#别忘了，注释掉之后，要加上shuffle=True
        ...
        for name in self.target_names:
            ...
            test_dataset = Test_Dataset(base_dataset, query_gallery='all', glove_start=True)
            query_dataset = Test_Dataset(base_dataset, query_gallery='query', glove_start=True)
