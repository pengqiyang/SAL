...
python3 train_glove_extra.py \
	   ...
	   --resume-i2-sem  /public/users/pengqy/log/peta/checkpoint_ep_pt_I2sem100.pth.tar \
	   --adj-file  /media/data2/pengqy/TIP/dataset/PETA/peta_adj.pkl \
       --save-dir /public/users/pengqy/log/peta-glove-extra-10 \
	   --gpu-devices 1 \
	   --al-alone-lr 0.000001 \
	   --sc-alone-lr 0.0001 \
       --al-alone-gamma 0.01 \
...
python3 train_glove_extra.py \
	   ...
	   --resume-i2-sem  /public/users/pengqy/log/peta/checkpoint_ep_pt_I2sem100.pth.tar \
	   --adj-file  /media/data2/pengqy/TIP/dataset/PETA/peta_adj.pkl \
       --save-dir /public/users/pengqy/log/peta-glove-extra-15 \
	   --gpu-devices 1 \
	   --al-alone-lr 0.000001 \
	   --sc-alone-lr 0.0001 \
       --al-alone-gamma 0.01 \
...
python3 train_glove_extra.py \
	   ...
	   --resume-i2-sem  /public/users/pengqy/log/peta/checkpoint_ep_pt_I2sem100.pth.tar \
	   --adj-file  /media/data2/pengqy/TIP/dataset/PETA/peta_adj.pkl \
       --save-dir /public/users/pengqy/log/peta-glove-extra-25 \
	   --gpu-devices 1 \
	   --al-alone-lr 0.000001 \
	   --sc-alone-lr 0.0001 \
       --al-alone-gamma 0.01 \
...
python3 train_glove_extra.py \
	   ...
	   --resume-i2-sem  /public/users/pengqy/log/peta/checkpoint_ep_pt_I2sem100.pth.tar \
	   --adj-file  /media/data2/pengqy/TIP/dataset/PETA/peta_adj.pkl \
       --save-dir /public/users/pengqy/log/peta-glove-extra-30 \
	   --gpu-devices 1 \
	   --al-alone-lr 0.000001 \
	   --sc-alone-lr 0.0001 \
       --al-alone-gamma 0.01 \
